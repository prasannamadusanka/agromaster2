...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/AdmininitialFinancial.css">
  ...
  <body>
    ...
    <button class="dropdown-btn">
      ...
      <div class="dropdown-container">
        ...
        <a href="<?php echo URLROOT; ?>/Adminpagesfi/financial" method="post" style="background-color : #08161E;">Financial Operator</a>
      </div>
    ...
    <div class="content">
      ...
      <div class="form">
        <form action="<?php echo URLROOT; ?>/Adminpagesfi/financial" method="post">
          ...
          <div>
            ...
            <input type="text" name="con_number" size="55" class="form-control form-control-lg <?php echo (!empty($data['con_number_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['con_number']; ?>"><br>
