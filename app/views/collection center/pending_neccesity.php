...
<button class="dropdown-btn" >
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="#home">Pending neccesities</a>
              ...
              <table id="customers">
                ...
                <tr>
                  ...
                  <td>2021/10/14</td>
                  <td>Not recived</td>
                  <td class="td-center"><a href="<?php echo URLROOT; ?>/CollectioncenterPages/neccesityMore"> More details</a></td>
                  <td class="td-center"><a href="#"> Close order</a></td>
                </tr>
                <tr>
                <td>N0-105</td>
                  <td>2021/10/14</td>
