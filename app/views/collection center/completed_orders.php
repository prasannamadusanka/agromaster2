            ...
            <div class="topnav">
              ...
              <table id="customers">
                ...
                <tr>
                  ...
                  <td class="td-center"><select id="counts">
                    <option  value="text4">Select driver</option>
                    <option value="text1">Select driver</option>
                    <option value="text2">text2</option>
                    <option value="text3">text3</option>
            </select></td>
                  <td class="td-center"><a href="<?php echo URLROOT; ?>/Collectioncenterpages/assignedordersmore"> show details</a></td>
                </tr>
                <tr>
                    <td>WP-106</td>
                    <td>Galle</td>
                ...
                <tr>
                    <td style="text-align: center;padding-right: 50px;" colspan="5"><button style="width:130px;text-align:center" class="save">Save changes</button></td>
                </tr>
              </table>
