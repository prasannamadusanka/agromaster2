...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/non-list.css">
...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <?php include_once('header.php'); ?>
    ...
    <button class="dropdown-btn drop-active">
          <a style="background-color: rgba(24, 23, 23, 0.8);"href="<?php echo URLROOT; ?>/Collectioncenterpages/reject"><i class="fas fa-bars"></i><span>Return management</span></a>
      </button>
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="#home">Return management</a>
                <input type="text" placeholder="Search by outlet..">
              ...
              <div class="cardBox">
                <div class="card">
                  <div class="front">
                    <img src="<?php echo URLROOT; ?>/img/reject.jpg">
                    <h3 style="font-size: medium;">Alkaduwa outlet</h3>
                    <p style="text-align:left;font-size:small">Returned Date - 2019/10/12<br>
            rejected value- Rs.7656.00<br>
               order value - Rs.14500<br>
               Driver - A.K.sumanapala</p>
                  </div>
                  <div class="back">
                    <h3>Rejection list</h3>
                   <p style="font-size: small;text-align: left;margin-bottom: 1px;">Carrot - 10kg(rs.150 per unit)</p>
                   <hr>
                   <p style="font-size:small;text-align: left;margin-bottom: 1px;">Potato - 15kg(rs.200 per unit)</p><hr>
                   <p style="font-size: small;text-align: left;margin-bottom: 1px;">B - onion - 3kg(rs.300 per unit)</p><hr>
