    ...
    <div class="content">
        ...
        <div class="shopping-cart">
            ...
            <div class="item">
              ...
              <div class="total-price">Stock In hand - 930kg</div>
            </div>
            <div class="item">
                <div class="buttons">
                <input type="checkbox">
              ...
              <div class="item">
                ...
                <div class="image">
                  <img width="120" height="80"src="<?php echo URLROOT; ?>/img/vegetables/Pumpkin.jpg" alt="" />
                </div>
        
                <div class="description">
                  <span>Pumpkin</span>
                  <span>Vegetable</span>
                  <span>Stock I.H - 678kg</span>
                </div>
                ...
                <div class="total-price">Required quanity - 66kg</div>
              </div>
            <!-- Product #2 -->
           
            <div class="item2">
                <p style="margin-left: 20px;">Closing Date</p>
                <input style="margin-left:20px;width:95%;height:30px"type="date" name="name" required/>
                <i class="fas fa-calendar-alt"></i>
              </div>
            <div style="margin-top: 20px;margin-bottom:30px;padding-left: auto;padding-right: auto;">
            <button id="save-but">Submit</button>
        </div>
        </form>
          </div>
        </div>
