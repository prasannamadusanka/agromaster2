    ...
    <div class="content">
      <div class="new">
        <div class="topnav">
            ...
            <a class="active" href="#home">More details - Reference number->205 </a>
          ...
          <div class="wrapper">
            <div class="product-info back1">
             <div class="product-text">
                ...
                <p>Added date       - 2021/10/12<br> Closing date - 2021/10/15<br> Assignment status - assigned<br> Assigned date - 2021/10/14</p>
              </div>
            ...
            <div class="product-info">
              <div class="product-text">
                <h1>Produc Assignment</h1>
                <h2>by intermediate transport operator</h2>
                <p>Carrot assigned 10kg from 64kg<br> Beans assigned 20kg from 67kg<br>Cabbage assigned 26kg from 67kg</p>
              </div>
