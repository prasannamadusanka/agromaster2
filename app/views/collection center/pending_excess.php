...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <?php include_once('header.php'); ?>
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingNeccesity">Pending Excesses </a>
                <a style="margin-right:0px; text-align:right" href="<?php echo URLROOT; ?>/Collectioncenterpages/neccesityAssignment">Assigned Excesses</a>
