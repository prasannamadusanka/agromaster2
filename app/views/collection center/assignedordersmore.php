    ...
    <div class="content">
      <div class="new">
        <div class="topnav">
            ...
            <a class="active" href="#home">More details - Reference number-><?php echo $data['order'][0]->id?></a>
          ...
          <div class="wrapper" >
            <div class="product-info back1">
             <div class="product-text">
                <h1>Order by</h1>
                <h2><?php echo $data['order'][0]->outlet_name?></h2>
                <p>Ordered date       - <?php echo $data['order'][0]->ordered_date?><br> Completed date - <?php echo $data['order'][0]->assigned_date?><br> Delivery date -  <?php echo $data['order'][0]->delivery_date?><br> Driver -<?php echo $data['order'][0]->driver?><br> Total amount(b.d) - RS.6789.00 </p>
              </div>
            ...
            <div class="product-info" >
              <div class="product-text">
                ...
                <h2>by collecion center</h2>
                <p><?php foreach ($data['order'] as $order):?>
                  <?php echo $order->product_name ?> assigned <?php echo $order->assigned_quantity ?> from <?php echo $order->oredered_quantity ?>
                   <?php endforeach; ?> </p>
                  
              </div>
              <div class="product-price-btn">
              
                <button type="button">Set as delivered</button>
              </div>
            </div>
          </div>
