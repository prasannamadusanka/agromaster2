          ...
          <div class="wrapper">
            <div class="product-info back1">
             <div class="product-text">
                <h1>Order by</h1>
                <h2>Kothalawala outlet</h2>
                <p>Ordered date       - 2021/10/12<br> Delivered date - 2021/10/15<br>  Driver - A.K SUMANAPAL<br> Total amount(b.d) - RS.790.00<br> Total amount(A.d) - RS.6900.00 </p>
              </div>
