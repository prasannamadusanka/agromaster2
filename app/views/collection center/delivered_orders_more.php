  ...
  <?php include_once('header.php'); ?>
    ...
    <!--sidebar end-->
      ...
      font-size:large;
                  ...
                  <div class="column3"> <span id="price">Rejected quantity</span> </div>
              </div>
              <?php foreach ($data['order'] as $order):?>
                <div class="row">
                  
                    <div class="column3"> <span id="name"> <?php echo $order->product_name ?></span> </div>
                    <div class="column3"> <span id="price"> <?php echo $order->ordered_quantity ?></span> </div>
                    <div class="column3"> <span id="price"><?php echo $order->assigned_quantity ?> </span> </div>
                    <div class="column3"> <span id="price"><?php echo $order->rejected_quantity ?> </span> </div>
