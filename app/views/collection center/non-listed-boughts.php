  ...
  ">
              ...
              foreach ($data['broughts'] as $broughts):?>
                <div class="row">
                    ...
                    <div class="column3"> <span id="price"> <?php echo $broughts->quantity ?></span> </div>
                    <div class="column3"> <span id="price"><?php echo $broughts->value; $total +=$broughts->value; ?> </span> </div>
                </div>
                <?php endforeach; ?>
                <div class="row">
