...
<button class="dropdown-btn" >
    ...
    <div class="dropdown-container">
      ...
      <a href="<?php echo URLROOT; ?>/Collectioncenterpages/deliveredorders"><i class="fas fa-bars"><span></i>Delivered orders</span></a>
        ...
        <button class="dropdown-btn">
          <a href="#"><i class="fas fa-bars"></i><span>REQUEST$request</span></a>
      </button>
      <div class="dropdown-container">
        <a href="<?php echo URLROOT; ?>/Collectioncenterpages/orderREQUEST$request"><i class="fas fa-bars"><span></i>order</span></a>
        <a href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingREQUEST$request"><i class="fas fa-bars"><span></i>pending</span></a>
      </div>
      <button class="dropdown-btn">
        <a href="#"><i class="fas fa-bars"></i><span>Requests</span></a>
    </button>
    <div class="dropdown-container drop-active">
      <a style="background-color: rgba(24, 23, 23, 0.8);" href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingRequest"><i class="fas fa-bars"><span></i>Request Management</span></a>
      <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/productRequest"><i class="fas fa-bars"><span></i>Add New Product</span></a>
    </div>
    <button class="dropdown-btn">
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingREQUEST$request">Pending REQUEST </a>
                <a style="margin-right:0px; text-align:right" href="<?php echo URLROOT; ?>/Collectioncenterpages/REQUEST$requestAssignment">Assigned Requests</a>
