            ...
            <input type="text" placeholder="Search..">
              ...
              <table id="customers">
                ...
                <tr>
                  ...
                  <td>2021/10/14</td>
                  <td class="td-center"><a href="">Reject order</a></td>
                  <td class="td-center"><a href="<?php echo URLROOT; ?>/collectioncenterpages/assignorder?id=<?php echo $pending_orders->id?>">complete order</a></td>
             </form>
                </tr>
                <?php endforeach; ?>
