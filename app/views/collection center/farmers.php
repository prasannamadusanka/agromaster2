...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <body>
    ...
    <div class = "gallery">
            ...
            <h4><?php echo $farmers->name?> - <?php echo $farmers->NIC?></h4>
              <p><?php echo $farmers->home_address?> <br><?php echo $farmers->contact_number?> <br><?php echo $farmers->product_name?> </p>
              <a href="<?php echo URLROOT; ?>/collectioncenterpages/nonlistedboughts?NIC=<?php echo $farmers->NIC?>"><h6>Non listed broughts</h6></a>
                <a href="<?php echo URLROOT; ?>/collectioncenterpages/paymentmanagement?NIC=<?php echo $farmers->NIC?>"><h6>Balance - <?php echo $farmers->balance?> </h6></a>
