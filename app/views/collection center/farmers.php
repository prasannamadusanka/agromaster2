  ...
  <body>
    ...
    <div class = "gallery">
            ...
            <img src="<?php echo URLROOT; ?>/img/farmer-icon.jpg">
              <h4>A.M. Sumanadasa - F56</h4>
              <p>Punchi pathana,Hikkaduwa<br>+9476886734<br>Tomato,Gerkin</p>
              <a href=""><h6>Balance - Rs.5676</h6></a>
            ...
            <h4>A.M. Sumanadasa - F56</h4>
              <p>Punchi pathana,Hikkaduwa<br>+9476886734<br>Tomato,Gerkin</p>
                <a href="<?php echo URLROOT; ?>/collectioncenterpages/paymentmanagement"><h6>Balance - Rs.0</h6></a>
            ...
            <div class="c">
              ...
              <button onclick = "location.href='<?php echo URLROOT; ?>/Collectioncenterpages/edit'" class="buy-1 button1">Edit</button>
              <button class="buy-1 button2">Remove </button>
            </div>
            <div class="c">
            <img src="<?php echo URLROOT; ?>/img/farmer-icon.jpg">
