  ...
  <?php include_once('header.php'); ?>
    ...
    <div class="content">
        <div class="testbox">
            ...
            <form action="/">
              <div style="text-align:left;color:#006b38ff;padding:0px;font-family:bevan;font-size: 35px;text-align: center;">Farmer registration</div>
              
              <div class="item">
                <p>Name of the Farmer</p>
              ...
              <div class="item">
                ...
                <div class="item">
                    ...
                    <select>
                      ...
                      <option value="1">Carbage</option>
                      <option value="2">Leeks</option>
                    </select>
                  </div>
                <div class="item">
                    <p>Frequent item (2)</p>
