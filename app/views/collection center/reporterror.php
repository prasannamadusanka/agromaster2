...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <?php include_once('header.php'); ?>
    ...
    <div class="dropdown-container drop-active">
      ...
      <a style="background-color: rgba(24, 23, 23, 0.8);" href="#"><i class="fas fa-bars"><span></i>Expenses</span></a>
    </div>
      <button class="dropdown-btn">
...
<table id="Home" align="center" >
  <tr>
  <td>&nbsp&nbsp This month report already avialble in the list! &nbsp&nbsp&nbsp&nbsp</td><td> </td>
  </tr>
  <tr> 
