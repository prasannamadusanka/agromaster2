            ...
            <form action="<?php echo URLROOT; ?>/collectioncenterpages/assignment" method="post">
              ...
              <input style="display:none" type="text" name="order_id" value ="<?php echo $data['id']?>">
                <div class="table-header">
                  ...
                  <div class="col col-2">Ordered quantity</div>
                  <div class="col col-4">In hand stock</div>
                  <div class="col col-3">Assigned quantity</div>  
               ...
               <?php foreach($data['order'] as $order) : ?>
                ...
                <div class="table-tx">
                  ...
                  <div class="col col-4"><?php echo $order->center_stock?></div>
                  <div class="col col-3"><input name="<?php echo $order->id?>" type="text" style="padding:0px;margin-left:15px;margin-top:0px;margin-bottom: auto;margin-top:auto;height:20px"></div>  
