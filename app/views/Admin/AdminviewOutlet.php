...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/AdminviewOutlet.css">
    ...
    <div class="content">
      ...
      <div class="details" >
          ...
          <table id="edit">
            <tr>
              <td>Name -</td>
              <td><div contenteditable="true"><?php echo $data['outlet']-> name; ?></div></td>
            </tr>
            <tr>
              <td>Address - </td>
            ...
            <tr>
              ...
              <td><div contenteditable="true"><?php echo $data['outlet']-> con_number; ?></div></td>
            </tr>
            <tr>
              <td>E-mail - </td>
