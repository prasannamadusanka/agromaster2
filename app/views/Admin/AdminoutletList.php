...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/AdminoutletList.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Spectral|Rubik|Trirong|Audiowide">
    <link href='https://fonts.googleapis.com/css?family=Bevan' rel='stylesheet'>00
  ...
  <body>
    ...
    <div class="content">
      <!-- <img src="RHA.jpg" class="bellicon"> -->
          <div class="tables">
        <h1> Outlets <button><a href="<?php echo URLROOT; ?>/Adminpagesoutlet/oaddrequest"><i></i><span>Add Outlet</span></a></button> </h1>
...
<table id="collectioncenters">
  ...
  <!-- <tr>
    ...
    <td>+94768867295</td>
    <td align="center"><a href="<?php echo URLROOT; ?>/Adminpagesoutlet/outletlocation">location</a></td>
    <td align="center"><a href="<?php echo URLROOT; ?>/Adminpagesoutlet/outletdetail">details</a></td>
    <td align="center"><a href="#">remove</a></td>
  </tr>
  <tr>
    <td>Mathale</td>
