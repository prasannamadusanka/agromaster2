...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/Adminoutletadingrequest.css">
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="requests">
        ...
        <!-- <a href="<?php echo URLROOT; ?>/Adminpagesoutlet/addoutlet"><u><u>Outlet - Kandy</u></a><br>
        <a href="<?php echo URLROOT; ?>/Adminpagesoutlet/addoutlet"><u>Outlet - Jaffna</u></a><br>
        <a href="<?php echo URLROOT; ?>/Adminpagesoutlet/addoutlet"><u>Outlet - Mathara</u></a><br>
        <a href="<?php echo URLROOT; ?>/Adminpagesoutlet/addoutlet"><u>Outlet - Anuradhapura</u></a><br> -->
