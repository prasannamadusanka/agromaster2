...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin/AdmindriverAddRequest.css">
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="requests">
        <h3>Requests</h3>
        <?php foreach($data['driveraddrequest'] as $request) : ?> 
        <a href="<?php echo URLROOT; ?>/Adminpagesd/adddriver/ <?php echo $request-> request_id; ?>"><u>FROM- <?php echo $request->requester_name; ?></u></a><br>
        <?php endforeach; ?>
      </div>
