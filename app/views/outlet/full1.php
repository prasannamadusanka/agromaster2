...
input[type=submit],input[type=reset]{
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                ...
                <a href="#home" style="text-align: right;color: blue;">Not paid</a>
  ...
  <div style="font-size: 28px;">
      ...
      <div style="margin-top: 20px;margin-right: 20px;">Paid Amount<var style="margin-left:530px;color: black;">Rs:102000.00</var></div>
      <div style="margin-top: 20px;">Amount to be paid<var style="color: black;margin-left: 480px;">Rs:20000.00</var></div>
    </div>
      <a href="pay"> <input type="submit" style="text-align: center;float: right;width: 350px;font-size: 26px;margin-right: 100px;margin-top: 80px;" name="submit" value="Proceed Payment" ></a>
            </div>
    </div>
