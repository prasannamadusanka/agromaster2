...
input[type=submit],input[type=reset]{
  ...
  <body>
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a class="active" href="#home">Manage Accepted Order Items<var style="margin-left: 90px;">Invoice No: 42011</var></a>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="number" name="Quantity"></td>
      ...
      <a href="accfinal1"><input type="submit" style="text-align: center;float: right;width: 200px;font-size: 26px;margin-right: 100px;margin-top: 80px;" name="submit" value="Done" ></a>
            </div>
    </div>
