   ...
   margin-top: 40px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background1.jpg') no-repeat;
    ...
    <div class="content">
        ...
        <div class="testbox" >
            ...
            <form action="<?php echo URLROOT; ?>/outlet/pay" method="post">
               ...
               <div class="item">
                ...
                <div class="item">
                    ...
                    <p style="font-size:23px">Invoice No: </p>
                      ...
                      <input type="text"   name="order_id" value="<?php echo $data['id']?>">
              ...
              <div class="item">
                ...
                <input type="number" max="10000000" name="amount" value="<?php echo $data['st']?>.00">
              </div>
