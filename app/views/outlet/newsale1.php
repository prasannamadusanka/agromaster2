...
<html lang="en" dir="ltr">
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/newsale.css">
...
.pt{
  ...
  <body>
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a class="active" href="#home">Add New Sale</a>
                <input type="text" placeholder="Search here">
               
              </div>
              <div class="pt"><a style="margin-left: 300px;font-size: 24px;">Select Date :</a>
  ...
  <input type="submit" style="text-align: center;float: right;width: 200px;font-size: 26px;margin-right: 100px;margin-top: 80px;" name="submit" value="Done" >
