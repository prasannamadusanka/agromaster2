...
<td>
               ...
               <td> <button type="submit" style="font-size: 13px;">Payment<br>Status</button></td>
</td>
  </form>     
<form action="<?php echo URLROOT; ?>/Outletpages/viewin1" method="post">
<td>
    ...
    <td> <button type="submit">Ordered<br>Date</button></td>
